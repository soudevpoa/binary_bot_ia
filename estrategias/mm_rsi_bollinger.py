...
class EstrategiaMMRSIBollinger:
    def __init__(self, mm_curto=5, mm_longo=20, rsi_period=14, rsi_upper=70, rsi_lower=30, bollinger_period=20, desvio=2):
    ...
    def decidir(self, prices):
        ...
        print(f"🔍 MM Curta: {ma_curta:.2f} | MM Longa: {ma_longa:.2f} | RSI: {rsi} | Bollinger: [{lower:.2f}, {upper:.2f}]")
